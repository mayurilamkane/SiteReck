...
public class CustomAdapterForCardProjectAll extends RecyclerView.Adapter<CustomAdapterForCardProjectAll.MyViewHolder> implements Filterable {
    Activity activity;
    Context context;
    List<DataForCardProject> data,filteredData;
    View view;
    @Override
    public void onBindViewHolder(@NonNull CustomAdapterForCardProjectAll.MyViewHolder holder, int position) {
...
//        mainActivity.startActivity(intent);
    ...
    public CustomAdapterForCardProjectAll(Context context, List<DataForCardProject> data, Activity activity) {
    ...
    @Override
    public CustomAdapterForCardProjectAll.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        view = inflater.inflate(R.layout.card_project_all,parent,false);
        return new CustomAdapterForCardProjectAll.MyViewHolder(view);
    }
    @Override
